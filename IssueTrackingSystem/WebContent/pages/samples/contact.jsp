            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 ml-auto text-center mb-5 mb-lg-0">
                        ...
                        <div>+91 7600426464</div>
						<div>+91 9328403221</div>
                    </div>
                    <div class="col-lg-4 mr-auto text-center">
                        <i class="fas fa-envelope fa-3x mb-3 text-muted"></i>
                        <!-- Make sure to change the email address in BOTH the anchor text and the link target below!-->
                        <a class="d-block" href="mailto:savaliyamaulik786@gmail.com">savaliyamaulik786@gmail.com</a>
						<a class="d-block" href="mailto:divyeshkumbhani05@gmail.com">divyeshkumbhani05@gmail.com</a>
                    </div>
                </div>
            </div>
        </section></div>
