						...
						<div class="container">
							<div class="row justify-content-center">
								<div class="col-lg-8 text-center">
									<div style="border: solid blue; border-radius: 35px">
										<h2 class="mt-0"
											style="font-style: italic; font-family: Apple; color: blue;">Let's
											Get In Touch!</h2>
									</div>
									<br> <br>
									...
									<h3
										style="font-style: italic; font-family: Apple; font-size: large;">
							...
							<div class="row">
								<div class="col-lg-4 ml-auto text-center mb-5 mb-lg-0">
									<i class="fas fa-phone fa-3x mb-3 text-muted"></i> <img
										src="Whatsapp.jpg" height="60" width="60" /><br> <br>
									<div style="font-style: italic; font-family: Apple;">
										<b>+91 7600426464</b>
									</div>
									<div style="font-style: italic; font-family: Apple;">
										<b>+91 9328403221</b>
								...
								<div class="col-lg-4 mr-auto text-center">
									...
									<img src="Gmail.jpg" height="60" width="60" /><br> <br>
									<a style="font-style: italic; font-family: Apple; color: blue"
