	...
	<ul class="nav">
		...
		<li class="nav-item"><a class="nav-link" data-toggle="collapse"
			...
			<div class="collapse" id="auth">
				<ul class="nav flex-column sub-menu">
					<li class="nav-item"><a class="nav-link"
						href="EditProfile?id=1"><img src="pages/icons/edit.svg"> Edit Profile </a></li>
					<li class="nav-item"><a class="nav-link"
						href="EditPasswordCheck?id=1"><img src="pages/icons/key.svg"> Change Password </a></li>
				</ul>
			</div></li>
		<li class="nav-item"><a class="nav-link" href="LogOut?id=1">
				<i class="menu-icon typcn typcn-bell"></i> <span class="menu-title">
					<img src="pages/icons/logout.svg">Logout </span>
		</a></li>
	</ul>
</nav>
