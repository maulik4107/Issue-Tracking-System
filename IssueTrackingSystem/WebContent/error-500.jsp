		...
		<div class="container-fluid page-body-wrapper full-page-wrapper">
			<div class="content-wrapper d-flex  error-page bg-info">
				...
				<div class="text-white" style="text-align: center; margin-top: 200px; margin-left: 200px;">
					...
					<marquee scrolldelay="10" direction="down" scrollamount="5" behavior="slide"><h2 style="font-size: 60px; font-style: italic; font-family: Apple; color: white; text-align: center;">Your Registration Request Sent Successfully !!!</h2></marquee>
