          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="auth">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="pages/samples/blank-page.jsp"> Blank Page </a>
                  </li>
                  <li class="nav-item">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="pages/samples/error-500.jsp"> 500 </a>
                  </li>
                </ul>
              </div>
            </li>
            ...
            <div class="row page-title-header">
              <div class="col-12">
                <div class="page-header">
                  <h5 class="page-title">Issue Tracking System</h5>
