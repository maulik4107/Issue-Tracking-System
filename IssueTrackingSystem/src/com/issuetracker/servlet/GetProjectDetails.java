...
public class GetProjectDetails extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<ProjectDetails> project=null;
		List<ProjectDetails> projectManager=null;
		try {
		 project=projectService.getProjectDetails();
		 projectManager=projectService.getManagerDetails();
		...
		RequestDispatcher dispatcher=request.getRequestDispatcher("allocateproject.jsp");
