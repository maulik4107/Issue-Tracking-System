...
/**
 * Servlet implementation class GetProjectManagerIssue
 */
public class GetProjectManagerIssue extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher =request.getRequestDispatcher("viewpmissue.jsp");
